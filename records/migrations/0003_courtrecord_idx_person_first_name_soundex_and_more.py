    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                models.Func(
                    models.F("first_name"), function="DAITCH_MOKOTOFF", template="DAITCH_MOKOTOFF(%(expressions)s)"
                ),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                models.Func(
                    models.F("last_name"), function="DAITCH_MOKOTOFF", template="DAITCH_MOKOTOFF(%(expressions)s)"
                ),
