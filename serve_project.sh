...
# Build a venv.
cd /home/django_user/fuzzy_demo
...
/home/django_user/fuzzy_demo/.venv/bin/python manage.py migrate
/home/django_user/fuzzy_demo/.venv/bin/python manage.py collectstatic --noinput
